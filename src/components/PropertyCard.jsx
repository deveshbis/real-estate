...
const PropertyCard = ({ property }) => {
    const { id, estate_title, description, image, price, location } = property;
    return (
        <div className="card md:w-80 lg:w-[460px] lg:ml-8 glass border border-black border-solid" data-aos="zoom-out-up" data-aos-duration="3000">
            <figure><img className='w-full h-[300px]' src={image} alt="car!" data-aos="zoom-in" data-aos-duration="3000"/></figure>
            <div className="card-body " >
                ...
                <hr />
                <hr />
                <p data-aos="fade-left" data-aos-duration="3000"><span className='font-bold'>Price: </span> {price}</p>
                <hr />
